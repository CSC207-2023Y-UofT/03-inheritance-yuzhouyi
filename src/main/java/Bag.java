...
public abstract class Bag {
     ...
     * its contents.)
     */
    public Bag(String colour, int space) {
        this.color = colour;
        this.capacity = space;
    ...
    public boolean addItem(String item) {
        if (numberOfContents < capacity) {
            ...
            if (n >= 0) System.arraycopy(this.contents, 0, list, 0, n);
            list[n] = item;
            this.contents = list;
    ...
    public String popItem() {
        if (this.numberOfContents == 0) {
            ...
            System.arraycopy(this.contents, 0, list, 0, n);
            String removed = this.contents[n];
            this.contents = list;
            this.numberOfContents--;
            return removed;
        }
